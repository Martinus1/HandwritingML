...
class SearchProtocolsVC: UIViewController {
...
extension SearchProtocolsVC: UITextFieldDelegate {
...
extension SearchProtocolsVC: UITableViewDelegate, UITableViewDataSource {
